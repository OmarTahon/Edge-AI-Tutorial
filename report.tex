...
\begin{center}
    \begin{tikzpicture}[node distance=4cm]
        ...
        \node (train) [process, right of=data] {2. Train \& Optimize \\ (\texttt{edgeai-modelmaker})};
        \node (compile) [process, right of=train] {3. Compile \& Quantize \\ (\texttt{edgeai-benchmark})};
        \node (deploy) [process, below of=compile, yshift=2.5cm] {4. Edge SDK \\ Inference};
